...
<body class="bg-light">
    <div class="container bg-white p-5 mt-5" id="ticket">
	    <div class="row">
			<div class="col-md-8">
			   <h6 class="mt font-weight-bold">IT / Collaborative ⇒ Head Of Collaborative Details</h6>
			</div>
			<div class="col-md-1">
			   <a href="department.php" class="btn btn-primary mt1" id="email">Update</a>
			</div>
			<div class="col-md-3">
			   <a href="newdepartment.php" class="btn btn-primary mt1" id="email">Update & Add More</a>
			</div>
		</div>
					    ...
					    <div class="col-md-12">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" id="designation" aria-describedby="emailHelp" placeholder="Head Of Collaborative">
									</div>
								</div>
							</div>
					    </div>
